...
! CHECK:  %[[VAL_6:.*]] = select %[[VAL_5]], %[[VAL_3]], %[[VAL_4]] : index
...
! CHECK:  %[[VAL_7:.*]] = select %[[VAL_2]], %[[VAL_0]], %[[VAL_6]] : !fir.box<!fir.array<?xi32>>
...
! CHECK:  %[[VAL_4:.*]] = select %[[VAL_2]], %[[VAL_1]]#1, %[[VAL_3]] : index
...
! CHECK:    fir.call @llvm.memmove.p0i8.p0i8.i64(%[[VAL_13]], %[[VAL_14]], %{{.*}}, %{{.*}}) : (!fir.ref<i8>, !fir.ref<i8>, i64, i1) -> ()
...
! CHECK:  %[[VAL_9:.*]] = arith.constant 0 : index
! CHECK:  %[[VAL_10:.*]] = select %[[VAL_5]], %[[VAL_7]], %[[VAL_9]] : index
...
! CHECK:    fir.call @llvm.memmove.p0i8.p0i8.i64(%[[VAL_19]], %[[VAL_20]], %{{.*}}, %{{.*}}) : (!fir.ref<i8>, !fir.ref<i8>, i64, i1) -> ()
...
! CHECK:  %[[VAL_8:.*]] = select %[[VAL_2]], %[[VAL_0]], %[[VAL_7]] : !fir.box<!fir.array<?x!fir.char<1,?>>>
...
! CHECK:    %[[VAL_20:.*]] = fir.do_loop {{.*}}
! CHECK:      fir.call @llvm.memmove.p0i8.p0i8.i64
! CHECK:    }
