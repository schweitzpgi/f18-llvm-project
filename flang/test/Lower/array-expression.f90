...
! CHECK:         %[[VAL_7:.*]] = select %[[CMP]], %[[VAL_7A]], %[[C0]] : index 
...
! CHECK:         %[[VAL_10:.*]] = select %[[CMP_2]], %[[VAL_10A]], %[[C0_2]] : index 
...
! CHECK:         %[[VAL_5:.*]] = select %[[CMP]], %[[VAL_5A]], %[[C0]] : index 
...
! CHECK:         %[[VAL_8:.*]] = select %[[CMP_2]], %[[VAL_8A]], %[[C0_2]] : index 
...
! CHECK:         %[[VAL_15:.*]] = select %[[CMP]], %[[VAL_15A]], %[[C0]] : index 
