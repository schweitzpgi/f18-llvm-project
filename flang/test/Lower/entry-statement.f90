...
function f1(n1) result(res1)
  ...
  ! CHECK:   %[[V_9:[0-9]+]] = select %[[V_8]], %c5{{.*}}, %c5{{.*}} : index
  ...
  ! CHECK:   %[[V_23:[0-9]+]] = select %[[V_22]], %c5{{.*}}, %c5{{.*}} : index
...
entry f2(n2)
  ...
  ! CHECK:   %[[V_11:[0-9]+]] = select %[[V_10]], %c5{{.*}}, %c5{{.*}} : index
...
entry f3
  ...
  ! CHECK:   %[[V_10:[0-9]+]] = select %[[V_9]], %c5{{.*}}, %c5{{.*}} : index
...
contains
  ...
  subroutine s2
    ...
    ! CHECK:   %[[V_5:[0-9]+]] = select %[[V_4]], %[[V_2]]#1, %c5{{.*}} : index
